...
Recently, I started diving deeper into [openEHR](https://openehr.org/) by building [open-cis](https://github.com/platzhersh/open-cis) and the python based openEHR sdk [oehrpy](https://github.com/platzhersh/oehrpy).
